...
Both `param1`, `param2`, `param3` (recommended for clarity) and custom names like `paramSnap`, `paramBody`, `paramDecay` work (see RealisticClap.cmajor). Use `[[ name: "..." ]]` for display labels only -- never in logic.
